...
// To fix error finding Vector3: Make sure you have a Scripts/19_VehicleDemo.as and all the Utilities folder in Scripts/Utilities. Run it by cd'ing to your project folder with AngelScripts, outside the Scripts folder, and then run: PathToYourUrho3DGoesHere/bin/Urho3DPlayer Scripts/19_VehicleDemo.as
